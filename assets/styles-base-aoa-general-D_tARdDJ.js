...
`}}function a(t,e,n){const l=s.Styles.LINK_STYLE.join("; ");return`
      <a href="${t}" 
         style="${l}"
...
`}function h(t,e,n){return`
      <img src="${t}" style="max-width: 600px; border: 0; display: block; outline: none; text-decoration: none; height: auto; font-size: 13px;" title=${e} alt="${n}" />`}return{paragraph:r,heading:c,link:a,list:p,image:h}}export{s as C,d as u};
